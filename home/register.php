...
<section class="login-block">
    ...
    <div class="form-group">
        ...
        <input type="email" class="form-control" placeholder="Enter Email" pattern="^([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5})$" name = "uEmail" id = "uEmail" required>
        <!-- <div class="valid-feedback">Company name looks good</div> -->
    ...
    <label class="form-control-label" for="confirm">Retype Password</label>
        ...
        <div class="invalid-feedback">Passwords no not Match</div>
    </div>
