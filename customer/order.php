            ...
            <div class="row py-5 p-4 bg-white rounded">
                ...
                <div class="p-4">
                    <h4 class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <span class="badge badge-success badge-pill text-white"><?php cartCount("cart"); ?></span>
                    </h4>
                    ...
                    <a href="" class = "btn btn-dark rounded-pill py-1  text-white  btn-lg btn-block cont">
